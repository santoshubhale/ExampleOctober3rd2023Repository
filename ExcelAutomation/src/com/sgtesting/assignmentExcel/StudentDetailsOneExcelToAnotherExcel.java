...
public class StudentDetailsOneExcelToAnotherExcel {

	public static void main(String[] args) {
		stateName();
	}

	private static void stateName() {
		...
		Cell cellsh2 = null;
		try {
			fin = new FileInputStream("C:\\Users\\Bablu\\Desktop\\Excel testing by using poi\\StudentDetails.xlsx");
			...
			fout = new FileOutputStream("C:\\Users\\Bablu\\Desktop\\Excel testing by using poi\\StudentDetailsnew.xlsx");
			wb.write(fout);
